                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col-auto">
                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">{{ round($profileCount*100, 0) }}%
    </div>
</div>
<div class="col">
    ...
    <div class="col-xl-3 col-md-6 mb-4">
        <div class="card border-left-primary shadow h-100 py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Prescriptions created
                        </div>
                        <div class="h5 mb-0 font-weight-bold text-gray-800">
                            {{ count(\App\Models\Prescription::all()) }}
                        </div>
                    </div>
                    <div class="col-auto">
                        <i class="far fa-address-card fa-2x text-gray-300"></i>
    ...
    <div class="col-xl-3 col-md-6 mb-4">
        <div class="card border-left-primary shadow h-100 py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Delivery orders created
                        </div>
                        <div class="h5 mb-0 font-weight-bold text-gray-800">
                            {{ count(\App\Models\Delivery::all()) }}
                        </div>
                    </div>
                    <div class="col-auto">
                        <i class="far fa-address-card fa-2x text-gray-300"></i>
    ...
    <div class="col-xl-3 col-md-6 mb-4">
        <div class="card border-left-primary shadow h-100 py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Drugs in stock
                        </div>
                        <div class="h5 mb-0 font-weight-bold text-gray-800">
                            {{ count(\App\Models\Stock::all()) }}
                        </div>
                    </div>
                    <div class="col-auto">
                        <i class="far fa-address-card fa-2x text-gray-300"></i>
